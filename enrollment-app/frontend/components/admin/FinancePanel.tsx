          ...
          <form onSubmit={handleManualAttendanceSubmit} className="min-w-0 rounded-2xl border border-sky-200 bg-gradient-to-br from-sky-50 via-white to-white p-5 shadow-sm sm:p-6">
            ...
            <div>
              ...
              <select
                ...
                className="block h-11 w-full min-w-0 max-w-full appearance-none rounded-xl border border-gray-300 bg-white px-3 py-2.5 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
              >
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="block min-h-[5.5rem] w-full min-w-0 max-w-full resize-y appearance-none rounded-xl border border-gray-300 bg-white px-3 py-2.5 outline-none transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100"
